...
# Ejemplo letra V  devuelve ["ivan","valeria","valentina","Vanesa", "violeta", "Viviana"]
...
# 4) b) Explique qué es un conflicto de fusión en Git y cómo se puede resolver. 

# Dada una funcion que haga la suma y la multiplicacion de dos numeros dados y que devuelva una lista con los 2 resultados.
